...
export default function Navbar() {
    ...
    return (
        <header className="w-full bg-white shadow-xl fixed top-0 left-0 z-50 transition">
                ...
                <div className="flex items-center justify-between h-20">
                            ...
                            {links.map((link) => (
                                <Link
                                    ...
                                    className={`pb-1 transition ${location.pathname === link.to
                                        ...
                                        : "text-black dark:text-black hover:text-blue-500 dark:hover:text-blue-400"
                                        }`}
                                >
                                    {link.label}
                                </Link>
                    ...
                    <div className="flex items-center space-x-3">
                        <button
                            ...
                            className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 shadow-sm"
                        >
